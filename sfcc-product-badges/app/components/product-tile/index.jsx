...
import {HeartIcon, HeartSolidIcon} from '@appspringtechsas/sfcc-product-badges/app/components/icons'
...
import DynamicImage from '@appspringtechsas/sfcc-product-badges/app/components/dynamic-image'

// Hooks
import {useIntl} from 'react-intl'

// Other
import {productUrlBuilder} from '@appspringtechsas/sfcc-product-badges/app/utils/url'
...
import {useCurrency} from '@appspringtechsas/sfcc-product-badges/app/hooks'
        ...
        <Box {...styles.container}>
            ...
            {enableFavourite && (
                ...
                >
                    ...
                    />
                    <ProductLabels labelsIds={product.c_PB_ProductLabelConfigurationIds || []} productId={productId} />
                </Box>
            )}
        </Box>
    )
